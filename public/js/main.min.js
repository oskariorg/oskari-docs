...
},{"navigo":5}],2:[function(require,module,exports){
/**
 * Oskari api documentation helper
 * Registers in global 'APIDOC' variable
 */
...
},{"navigo":5}],3:[function(require,module,exports){
/**
 * Oskari api documentation helper
 * Registers in global 'APIDOC' variable
 */
        ...
        var getPanel = function(namespace, requests) {
            ...
            for (var key in sorted) {
                ...
                entries.forEach(function(req) {
                    const item = requestItemTemplate.clone();
                    const link = item.find('a');
...
},{"navigo":5}],4:[function(require,module,exports){
...
},{"./apidoc_bundle":1,"./apidoc_event":2,"./apidoc_request":3,"navigo":5}],5:[function(require,module,exports){
